...
@section('content')
    <section class="section">
        ...
        <form action="{{ route('compencategories.update', $compenCategory->id) }}" method="POST">
            @csrf
            @method('put')
            <div class="card">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="complaint" id="complaint"
                                    class="form-control @error('complaint') is-invalid @enderror" value="{{ $compenCategory->complaint }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="price" id="price"
                                    class="form-control @error('price') is-invalid @enderror" value="{{ $compenCategory->price }}"
